...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4)
import json
...
def compute_hash(u: E, u_r: E) -> Fq:
    ...
    result = str(u[_sage_const_0 ]) + str(u_r[_sage_const_0 ]) # Concatenate the two x values
...
def save_proof(u: E, proof: Tuple[E, Fq, Fq]):
    ...
    with open('proof.json', 'w') as f:
        json.dump({
            'u': {
                'x': str(u[_sage_const_0 ]),
                'y': str(u[_sage_const_1 ])
            },
            'u_r': {
                'x': str(u_r[_sage_const_0 ]),
                'y': str(u_r[_sage_const_1 ])
            },
            'alpha_z': str(alpha_z),
            'beta_z': str(beta_z)
        }, f, indent = _sage_const_4 ) 
